...
{
	ktime_t diff;
	WARN_ONCE(ktime_after(localclocks[0], localclocks[1]), "Calclock: The order of two clocks is reversed!");
...
void __ktprint(int depth, char *fn_name, ktime_t time, uint64_t count, size_t nr_threads);
